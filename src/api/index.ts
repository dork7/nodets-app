...
import { fileStorageRouter } from '@/api/fileStorage/fileStorageRouter';
import { goalsRouter } from '@/api/goals/goalsRouter';
import { healthCheckRouter } from '@/api/healthCheck/healthCheckRouter';
import { kafkaRouter } from '@/api/kafka/kafkaRouter';
import { layaRouter } from '@/api/laya/router';
import { llamaIndexRouter } from '@/api/llamaIndex/router';
import { localStorageRouter } from '@/api/localStorage/localStorageRouter';
...
router.use('/localStorage', localStorageRouter);
router.use('/fs-util', fileStorageRouter);
router.use('/rag', ragRouter);
router.use('/llamaIndex', llamaIndexRouter);
router.use('/laya', layaRouter);
